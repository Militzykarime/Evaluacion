    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
           <!--Inputs para los datos del producto-->
				Nombre del producto: <input class="form-control" type="text" name="txtNom" size="17" required>

				Precio del producto: <input class="form-control" type="number" name="txtPre" size="17" required>
				
				Existencia: <input class="form-control" type="number" name="txtExt" size="17" required>
      </div>
